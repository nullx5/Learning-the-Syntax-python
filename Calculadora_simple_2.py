...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.op_suma = QtGui.QRadioButton(Form)
        self.op_suma.setGeometry(QtCore.QRect(110, 140, 82, 17))
        self.op_suma.setObjectName(_fromUtf8("op_suma"))
        self.op_resta = QtGui.QRadioButton(Form)
        self.op_resta.setGeometry(QtCore.QRect(110, 170, 82, 17))
        self.op_resta.setObjectName(_fromUtf8("op_resta"))
    ...
    def retranslateUi(self, Form):
        ...
        self.op_suma.setText(_translate("Form", "+", None))
        self.op_resta.setText(_translate("Form", "-", None))
